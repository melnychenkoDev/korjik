...
<body <?php body_class(); ?>>
	...
	<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=634249067846626&ev=PageView&noscript=1"/></noscript>
	<!-- End Meta Pixel Code -->

	<!-- Google Tag Manager (noscript) -->
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P8LTNLG" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
...
<div id="page" class="site">
            ...
            <div class="site__header_top">
                ...
                <div class="info">
                    <div class="info_item call">
                        <?php $i = 0; if (have_rows('header_number', 'option')) : ?>
                    ...
                    <div class="info_item delivery">
                        <div class="top icon icon-delivery-zone"><a class="title" href="<?=get_page_link(150)?>"><?= __('Зоны доставки', 'korjik')?></a></div>
                        <div class="text"><?= __('Часик в радость, коржик в сладость', 'korjik')?></div>
                    </div>
                </div>
                    ...
                    <?php if (have_rows('social_networks', 'option')) : ?>
                        <?php while (have_rows('social_networks', 'option')) : the_row(); ?>
                            <div class="social__networks_item">
                                <a href="<?= the_sub_field('social_network_link') ? the_sub_field('social_network_link') : '#'; ?>" target="_blank">
    ...
    <div class="site__header_mob_menu">
        ...
        <div class="info">
            ...
            <div class="info_item delivery">
                <div class="top icon icon-delivery-zone-main-color"><a class="title" href="#"><?= __('Зоны доставки', 'korjik')?></a></div>
                <div class="text"><?= __('Часик в радость, коржик в сладость', 'korjik')?></div>
            </div>
        </div>
        <div class="social__networks">
...
<!--            <div style="width: 100%; height: 1px;opacity: 0;pointer-events: none;"></div>-->
    ...
    <div class="open_cart_btn mob"><?= __('В корзине', 'korjik')?> <span style="margin: 0 3px;" class="count"><?=$count?></span> <?= __('товаров', 'korjik')?>
        <div class="open_cart_btn-message">
            <div class="title"><?= __('Браток, ну ты че?', 'korjik')?></div>
            <div class="sub-tit"><?= __('У тебя в корзине пусто, добавь ченить', 'korjik')?></div>
        </div>
